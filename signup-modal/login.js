function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('User has started to type input.');
...
function enableButton(letter, capital, number, length, match) {
    ...
    var condition = letter.classList.contains("correct") && capital.classList.contains("correct") && number.classList.contains("correct") && length.classList.contains("correct") && match.classList.contains("correct"); // TODO: Replace false with the correct condition
    if(condition) {       
